...
const createImage = function (imgPath) {
  return new Promise(function (resolve, reject) {
    ...
    img.addEventListener('load', function () {
      imgContainer.append.insertAdjacentHTML('beforeend', img.src);
    });
  });
...
// createImage(
//   'E:complete-javascript-course-mastercomplete-javascript-course-master\16-Asynchronousstarterimgimg-1.jpg'
// );
