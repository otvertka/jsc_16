...
const getCountryData = function (country) {
  ...
  request.open('GET', 'https://restcountries.com/v3.1/name/portugal'); // Метод XMLHttpRequest.open() инициализирует новый запрос или повторно инициализирует уже созданный.
