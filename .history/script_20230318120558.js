...
//   try {
//     const imgs = imgArr.map(async d => await createImage(d));
...
// Async/ await
// const fetchData = () =>
//   // создали промис, в случае успешного выполнения возвращает список имён
//   Promise.resolve({
//     data: ['Jack', 'Max', 'Artur'],
//   });

// const getNamesData = () => {
//   fetchData().then(data => console.log(data)); // создали функцию, в которой вызываем Промис и
//   return 'done';
// };
...
fetch('https://api.github.com/users/vasilymur').then(res => console.log(res));
