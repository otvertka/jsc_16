...
// CHALLENGE # 1  .  TEST COORD: 52.508, 13.381;  19.037, 72.873;   -33.933, 18.474
const whereAmI = function (lat, lng) {
  fetch(
    `https://api.geoapify.com/v1/geocode/reverse?lat=${lat}&lon=${lng}&type=country&apiKey=YOUR_API_KEY`
  ).then(response => {
